...
namespace Reminder.Parsing
{
	public static class MessageParser
	{
		...
		{
			return
				"Напиши мне что и когда тебе напомнить. " +
				"Можешь написать \"Через 10 минут пойти поесть\" " +
				"или \"совещание через 2 ч\". " +
				"Можно написать \"31.12.2019 в 23:59 поздравить всех!\"";
		}
	}
}
